...
export interface AppBootstrapDeps {
  ...
  stores: {
    ...
    appStore: {
      ...
      setActiveConfigPath: (path: string | null) => Promise<void>
    }
    localeStore: {
      initializeStore: () => Promise<void>
