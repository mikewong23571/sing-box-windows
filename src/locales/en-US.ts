export default {
  ...
  proxy: {
    ...
    favorites: 'Fav:',
    nodeCount: 'Nodes:',
    noProviders: 'No proxy providers',
    noNodes: 'No available nodes',
    selectGroup: 'Please select a proxy group',
  ...
  connections: {
    ...
    noClosed: 'No closed connections',
    on: 'On',
    off: 'Off',
    source: 'Source',
  ...
  rules: {
    ...
    rulesTab: 'Rules',
    providersTab: 'Rule Sets',
    updateAll: 'Update All',
    updateAllSuccess: 'Triggered update for all Rule Sets',
    count: 'Count',
    updatedAt: 'Updated',
    noProviders: 'No Rule Sets',
    enabled: 'Enabled',
    disabled: 'Disabled',
    custom: {
      tab: 'Custom',
      ...
      edit: 'Edit',
      delete: 'Delete',
      deleteConfirm: 'Delete this custom rule?',
      addTitle: 'Add Custom Rule',
      editTitle: 'Edit Custom Rule',
      cancel: 'Cancel',
      confirm: 'Save',
      matchType: 'Match Type',
      payload: 'Payload',
      payloadPlaceholder: 'One per line, or comma-separated (e.g. example.com, *.test.com)',
      action: 'Action',
      note: 'Note',
      notePlaceholder: 'Optional',
      empty: 'No custom rules',
      hint: 'Custom rules are persisted locally and take effect after kernel restart. Different from the built-in rules above (runtime only).',
      addSuccess: 'Rule added (effective after kernel restart)',
      updateSuccess: 'Rule updated (effective after kernel restart)',
      deleteSuccess: 'Rule deleted (effective after kernel restart)',
      matchTypes: {
